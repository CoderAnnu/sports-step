...
<div id="payment" class="woocommerce-checkout-payment card bg-transparent rounded">
  <div class="card-body">
    ...
    <div class="place-order pt-3">
      ...
      <div>
        <?php echo apply_filters('woocommerce_order_button_html', '<button type="submit" class="btn btn-primary btn-lg text-white" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr($order_button_text) . '" data-value="' . esc_attr($order_button_text) . '">' . esc_html($order_button_text) . '</button>'); // @codingStandardsIgnoreLine 
        ?>
      </div>
